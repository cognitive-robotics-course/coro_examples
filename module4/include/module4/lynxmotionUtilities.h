/*******************************************************************************************************************
*
*   Interface file for the lynxmotionUtilities functions
*
*   Audit Trail
*   -----------
*   Extracted from code embedded in the implementation file the pickAndPlace application
*   David Vernon
*   11 February 2022
*
********************************************************************************************************************
...
#ifdef ROS
       #include <unistd.h>
       #define ROS_PACKAGE_NAME "module4"
#else
       #include <Windows.h>
#endif
...
struct robotConfigurationDataType {
   ...
   bool  simulator;                   // flag to indicate that the simulator is being used
};
...
/***************************************************************************************************************************
   ...
   Lynxmotion simulator functions 
