/* 
  ...
  Audit Trail
  --------------------
  Removed ../data/ prefix from contourExtractionInput.txt entries
  Abrham Gebreselasie
  3 March 2021
...
const char* contour_window_name      = "Contours";
...
int main() {
   ...
   const char input_filename[MAX_FILENAME_LENGTH] = "contourExtractionInput.txt";    
