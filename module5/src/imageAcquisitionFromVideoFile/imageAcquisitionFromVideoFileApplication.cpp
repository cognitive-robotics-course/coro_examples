/* 
  ...
  1.  a filename of a video to be displayed
  ...
  Functions to acquire image from image file and camera removed.
  Abrham Gebreselasie
  24 March 2021
...
int main() {
   ...
   const char input_filename[MAX_FILENAME_LENGTH] = "imageAcquisitionFromVideoFileInput.txt";
   ...
   if ((fp_in = fopen(input_path_and_filename,"r")) == 0) {
	  printf("Error can't open input imageAcquisitionFromVideoFileInput.txt\n");
     prompt_and_exit(1);
   }

   printf("Example of how to use openCV to acquire and display images\n");
   printf("from video file.\n\n");
